...
Vector2.prototype = {
    ...
    angleDegreesToRadians: function ( degrees )
    {
        return (Math.PI * degrees) / 180;
    },
    
    angleRadiansToDegrees: function ( radians )
    {
    ...
    /*
    rotateVector: function (angle, lenght){
